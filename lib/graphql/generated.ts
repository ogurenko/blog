...
export type ArticleQuery = { __typename?: 'Query', articles?: Maybe<Array<Maybe<{ __typename?: 'Article', slug: string, title: string, content: string, description: string, published_at?: Maybe<any>, created_at: any, updated_at: any, author?: Maybe<{ __typename?: 'Writer', name?: Maybe<string> }>, image?: Maybe<{ __typename?: 'UploadFile', url: string }>, category?: Maybe<{ __typename?: 'Category', id: string, name: string, created_at: any, updated_at: any, slug: string }> }>>> };

export type ArticleSnippetFragment = { __typename?: 'Article', id: string, slug: string, title: string, content: string, description: string, created_at: any, updated_at: any, author?: Maybe<{ __typename?: 'Writer', name?: Maybe<string> }>, category?: Maybe<{ __typename?: 'Category', id: string, name: string, created_at: any, updated_at: any, slug: string }>, image?: Maybe<{ __typename?: 'UploadFile', url: string }> };

export type ArticlesCountQueryVariables = Exact<{ [key: string]: never; }>;


export type ArticlesCountQuery = { __typename?: 'Query', articlesConnection?: Maybe<{ __typename?: 'ArticleConnection', aggregate?: Maybe<{ __typename?: 'ArticleAggregator', totalCount?: Maybe<number> }> }> };

export type ArticlesQueryVariables = Exact<{ [key: string]: never; }>;


export type ArticlesQuery = { __typename?: 'Query', articles?: Maybe<Array<Maybe<{ __typename?: 'Article', id: string, slug: string, title: string, content: string, description: string, created_at: any, updated_at: any, author?: Maybe<{ __typename?: 'Writer', name?: Maybe<string> }>, category?: Maybe<{ __typename?: 'Category', id: string, name: string, created_at: any, updated_at: any, slug: string }>, image?: Maybe<{ __typename?: 'UploadFile', url: string }> }>>> };

export type CategoriesQueryVariables = Exact<{ [key: string]: never; }>;


export type CategoriesQuery = { __typename?: 'Query', categories?: Maybe<Array<Maybe<{ __typename?: 'Category', id: string, name: string, created_at: any, updated_at: any, slug: string }>>> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    Article(variables: ArticleQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<ArticleQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ArticleQuery>(ArticleDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Article');
    },
    ArticlesCount(variables?: ArticlesCountQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<ArticlesCountQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ArticlesCountQuery>(ArticlesCountDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'ArticlesCount');
    },
    Articles(variables?: ArticlesQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<ArticlesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ArticlesQuery>(ArticlesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Articles');
    },
